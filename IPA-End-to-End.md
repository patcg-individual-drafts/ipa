...
* [2. Protocol](#2-protocol)
  ...
  * [2.8 Secure Multi Party Computation between a _helper party network_ (P<sub>1</sub>, P<sub>2</sub>, P<sub>3</sub>)](#28-secure-multi-party-computation-between-a-helper-party-network-p1-p2-p3)
